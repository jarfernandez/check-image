...
- Do not escape backticks with a backslash (`\`) in commit messages or PR titles/descriptions.
...
- Comprehensive unit tests cover all commands and internal packages with 94.1% overall coverage.
