...
Pre-built binaries include the correct version number (e.g., `check-image version --short` returns `v0.21.1`). <!-- x-release-please-version -->
...
go install github.com/jarfernandez/check-image/cmd/check-image@v0.21.1 # x-release-please-version
```
...
```bash
docker pull ghcr.io/jarfernandez/check-image:0.21.1 # x-release-please-version
```
...
| `version` | No | `0.21.1` <!-- x-release-please-version --> | check-image version to use |
