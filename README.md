...
Pre-built binaries include the correct version number (e.g., `check-image version` returns `v0.2.1`).
...
go install github.com/jarfernandez/check-image/cmd/check-image@v0.2.1
```
